...
int mesNumero(string mes) {
  int m_mes;
  if(mes == "Jan") return m_mes = 1;
  else if(mes == "Feb") return m_mes = 2;
  else if(mes == "Mar") return m_mes = 3;
  else if(mes == "Apr") return m_mes = 4;
  else if(mes == "May") return m_mes = 5;
  else if(mes == "Jun") return m_mes = 6;
  else if(mes == "Jul") return m_mes = 7;
  else if(mes == "Aug") return m_mes = 8;
  else if(mes == "Sep") return m_mes = 9;
  else if(mes == "Oct") return m_mes = 10;
  else if(mes == "Nov") return m_mes = 11;
  else return m_mes = 12;
}
