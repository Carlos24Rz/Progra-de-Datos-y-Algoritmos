...
public:
    ...
    //     // splitting the second ip
    //     int splitIpB[4];
    //     part = "";
    //     i = 0;
    //     for(auto x : b.m_ip){
    //         if((x == '.') || x == ':'){
    //             splitIpB[i] = stoi(part);
    //             part = "";
    //             i++;
    //         }
    //         else
    ...
    //     // for(int i=0; i<4; i++)
    //     //     cout << splitIpB[i] << endl;

    //     if(splitIp[0] <= splitIpB[0])
    //     {
    //         if(splitIp[0] == splitIpB[0])
    //         {
    //             if(splitIp[1] <= splitIpB[1])
    //             {
    //                 if(splitIp[1] == splitIpB[1])
    //                 {
    //                     if(splitIp[2] <= splitIpB[2])
    //                     {
    //                         if(splitIp[2] == splitIpB[2])
    //                         {
    //                             if(splitIp[3] <= splitIpB[3])
    //                             {
    //                                 if(splitIp[3] == splitIpB[3])
    //                                 {
    //                                     if(m_mes <= b.m_mes)
